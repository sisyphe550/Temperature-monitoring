...
更新：2026-09-18；C10/C11。原OQ编号保留用于追溯。**设计已决定、实现待验收、外部输入待具备是三种状态；不能混用。**
...
| OQ-14 | Swift6/Xcode16.4、系统SQLite、schema-v1/WAL/NORMAL、固定文件布局 | 08/09/contracts | W01/W03构建/存储验证 |
