...
更新：2026-09-18；交接基线v1。接手入口：[00](docs/00-agent-handoff.md)。
...
当前用户指令 > 01现行需求＋21契约 > 02～13专项设计 > 22执行步骤。15/18记录决策与来源；19/20解释复用；旧research/validation是历史证据，不能作为重新启用旧要求的理由。冲突须修正文档和测试，不靠隐藏代码决定。
